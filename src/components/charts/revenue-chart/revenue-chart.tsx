...
export const RevenueChart = memo(function RevenueChart({ range = "30d" }: { range?: DateRange }) {
  ...
  return (
    <div 
      className={cn("bg-card rounded-xl p-5 border border-border", isRTL && "font-vazir")} 
      dir={isRTL ? "rtl" : "ltr"}
    >
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData}>
            ...
            <YAxis 
              ...
              tickFormatter={(v) => isRTL ? v.toLocaleString("fa-IR") : `$${v/1000}k`}
              tick={{ fontSize: 11 }} 
              axisLine={false} 
              tickLine={false} 
            />
